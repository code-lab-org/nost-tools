...
class TestCredentials(unittest.TestCase):
    ...
    def test_service_account_mode_valid(self):
        ...
        creds = Credentials(
            client_id="service-account-id", client_secret_key="service-account-secret"
        )
    ...
    def test_missing_client_id_fails(self):
        ...
        with self.assertRaises(ValidationError) as context:
            Credentials(client_secret_key="client-secret")
        self.assertIn(
            "client_id and client_secret_key must be provided together",
    ...
    def test_username_without_password_fails(self):
        ...
        self.assertIn(
            "username and password must be provided together", str(context.exception)
        )
