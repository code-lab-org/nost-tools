...
class Satellite(Entity):
    ...
    def nadirPoint(self, pos, vel):
        ...
        # attQuat = R.from_matrix(R_bi).as_quat()
        
        targetRot = R.from_matrix(R_bi)*R.from_euler('x', 45, degrees=True)
        attQuat = targetRot.as_quat()
        
        print("CURRENT ATTITUDE IS!!!!", attQuat)
