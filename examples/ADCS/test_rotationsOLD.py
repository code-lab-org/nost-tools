...
for i in range(steps):
    ...
    eulerRot = R.from_euler('xyz', np.array(eulerRad))
    currentQuat = eulerRot.as_quat()
    
    # with scikit-kinematics
    #currentQuat = skin.quat.Quaternion(currentQuat)
    # currentQuat = skin.quat.calc_quat(w,currentQuat[:3],1,"sf")
    # currentQuat = np.array([currentQuat[0,1],currentQuat[0,2],currentQuat[0,3],currentQuat[0,0]])
