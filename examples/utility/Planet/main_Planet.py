...
if __name__ == "__main__":
    ...
    names = ["SKYSAT-A","SKYSAT-B","SKYSAT-C1","SKYSAT-C2","SKYSAT-C3","SKYSAT-C4","SKYSAT-C5","SKYSAT-C6","SKYSAT-C7","SKYSAT-C8","SKYSAT-C9","SKYSAT-C10","SKYSAT-C11","SKYSAT-C12","SKYSAT-C13","SKYSAT-C14","SKYSAT-C15","SKYSAT-C16","SKYSAT-C17","SKYSAT-C18","SKYSAT-C19"]
    ...
    constellation = Constellation('planet', app, indices, names, ES)
