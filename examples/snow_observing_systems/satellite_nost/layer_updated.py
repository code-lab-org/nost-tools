...
class LayerPublisher(WallclockTimeIntervalPublisher):
    ...
    def publish_message(self):
        ...
        logger.info(f"> Elapsed seconds: {elapsed_seconds}")
...
if __name__ == "__main__":
    ...
    layer_publisher = LayerPublisher(app, constellation, timedelta(seconds=10))
    ...
    app.start_up(
        ...
        time_status_init=datetime(2024, 1, 7, tzinfo=timezone.utc), #datetime.now(timezone.utc),
