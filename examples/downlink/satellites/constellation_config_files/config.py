...
SSR_CAPACITY = [280,280] # Capacity of onboard Solid State Recorder in Gigabytes
PCT_CAPACITY_USED = [0.5, 0.5] # Arbitrarily starting with SSR half full, but will offload at first pass
