...
if __name__ == "__main__":
    ...
    manager.execute_test_plan(
        datetime(2022, 11, 21, 7, 20, 0, tzinfo=timezone.utc),                    # scenario start datetime
        datetime(2022, 11, 21, 12, 20, 0, tzinfo=timezone.utc),                   # scenario stop datetime
        ...
        time_status_init=datetime(2022, 11, 21, 7, 21, 0, tzinfo=timezone.utc),   # optional initial scenario datetime to start publishing time status 'heartbeat' messages
