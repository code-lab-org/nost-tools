...
MIN_ELEVATION = 20.0  # minimum view angle (degrees) for ground-satellite communications
SCALE = 60.0
...
GROUND = pd.DataFrame(
    ...
    data={
        ...
        "elevAngle": [MIN_ELEVATION, MIN_ELEVATION, MIN_ELEVATION, MIN_ELEVATION, MIN_ELEVATION, MIN_ELEVATION, MIN_ELEVATION, MIN_ELEVATION, MIN_ELEVATION, MIN_ELEVATION, MIN_ELEVATION],
        ...
        "costPerSecond": [0.17, 0.17, 0.17, 0.17, 0.17, 0.17, 0.17, 0.17, 0.17, 0.17, 0.17]
    }
