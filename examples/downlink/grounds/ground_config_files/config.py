...
MIN_ELEVATION_SVALBARD = (
    5.0  # minimum view angle (degrees) for ground-satellite communications
)
MIN_ELEVATION_AWS = (
    20.0  # minimum view angle (degrees) for ground-satellite communications
)
SCALE = 60.0
