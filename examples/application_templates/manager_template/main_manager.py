...
if __name__ == "__main__":
    # Load the connection and execution configuration. Broker settings, the
    # scenario window, and the time scale all come from the YAML file, so this
    # script does not need to be edited to change a test case.
    config = ConnectionConfig(yaml_file="template.yaml")
