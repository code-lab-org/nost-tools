...
FIELD_OF_REGARD = [
    ...
    float(os.getenv("FIELD_OF_REGARD", 112.56))
]  # degrees (field-of-view for VIIRS = 112.56-degrees)

SSR_CAPACITY = [280,343] # Capacity of onboard Solid State Recorder in Gigabits for Suomi NPP and NOAA-20 respectively
CAPACITY_USED = [0.30, 0.25] # Fractional value from 0 (empty) to 1 (full). Arbitrarily starting with SSR somewhat full, but will offload at first pass
