...
if __name__ == "__main__":
    ...
    # for dashboard plot
    fig = px.line(df, x='Request_Time', y='Flow_Rate', color='Location', markers=True,
                      labels={"Request_Time":"Request Time", "Flow_Rate":"Flow Rate (ft^3/s)"},
                      title='Mississippi River Flow Rate at Memphis and Baton Rouge')
    ...
    def update_fig(n):
        ...
        fig = px.line(dffig, x='Request_Time', y='Flow_Rate', color='Location', markers=True,
                      labels={"Request_Time":"Request Time", "Flow_Rate":"Flow Rate (ft^3/s)"},
                      title='Mississippi River Flow Rate at Memphis and Baton Rouge')
        return fig
