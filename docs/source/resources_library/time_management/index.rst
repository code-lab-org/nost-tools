...
The :ref:`NOS-T tools library <nostTools>` contains a function for synchronizing applications with the NTP. The following code block shows an example of real-time management in the :ref:`Scalability example <scalability>`:
